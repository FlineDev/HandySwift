...
if workspace version > /dev/null 2>&1 ; then
    ...
    workspace validate $1 $2 $3 $4 •use‐version 0.35.1
    ...
    ~/Library/Caches/ca.solideogloria.Workspace/Versions/0.35.1/workspace validate $1 $2 $3 $4 •use‐version 0.35.1
elif ~/.cache/ca.solideogloria.Workspace/Versions/0.35.1/workspace version > /dev/null 2>&1 ; then
    echo "Using system cache of Workspace..."
    ~/.cache/ca.solideogloria.Workspace/Versions/0.35.1/workspace validate $1 $2 $3 $4 •use‐version 0.35.1
elif .build/SDG/Workspace/workspace version > /dev/null 2>&1 ; then
    echo "Using repository cache of Workspace..."
    .build/SDG/Workspace/workspace validate $1 $2 $3 $4 •use‐version 0.35.1
else
